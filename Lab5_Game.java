...
public class Lab5_Game extends JFrame {
    ...
    public Lab5_Game() {
        ...
        JLabel gamesWonLabel = new JLabel("GEME WON:");
            ...
            public void startGameMedium() {
        	    ...
        	    for (int i = 0; i < 25; i++) {
        	      ...
        	      if(greenBtn == i) {
        	    	  ...
        	    	  easyBtns[i].addActionListener(new ActionListener() {
        	    		  @Override
        	    		  public void actionPerformed(ActionEvent e) {
        	            	((JButton) e.getSource()).setBackground(Color.green);
		...
		//Cyan theme
		cyanThemeMenuItem.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
